...
from app.domains.kakao_authentication.adapter.outbound.cache.user_session_redis_adapter import UserSessionRedisAdapter
...
def get_request_access_token_usecase(
    ...
    return RequestAccessTokenUseCase(
        ...
        temp_token=TempTokenRedisAdapter(redis_client=redis),
        user_session=UserSessionRedisAdapter(redis_client=redis),
    )
